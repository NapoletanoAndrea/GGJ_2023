...
public class AudioManager : MonoBehaviour
{
    ...
    public Dictionary<AudioCueSO, SoundEmitter> SoundEmitters => soundEmitters;
    ...
    public void PlaySFX(AudioCueSO audioCue, Vector3 position = default) {
        if (!audioCue) {
            return;
        }
        ...
        if (!audioCue.isPlayableOverSelf && soundEmitter.IsPlaying()) {
            return;
        }
